...
import { CandidateService, RestCandidate } from './candidate.service';

const requireRestSample: RestCandidate = {
  ...sampleWithRequiredData,
  availableDate: sampleWithRequiredData.availableDate?.toJSON(),
};
