...
/**
 * REST controller for managing {@link com.devguru.submission.domain.Candidate}.
 */
@RestController
@RequestMapping("/api")
public class CandidateResource {
    ...
    public ResponseEntity<List<Candidate>> getAllCandidates(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
