...
@RestController
@RequestMapping("/api/submission-tracker-ang-kafka")
public class SubmissionTrackerAngKafkaResource {

    private final Logger log = LoggerFactory.getLogger(SubmissionTrackerAngKafkaResource.class);
    ...
    public SubmissionTrackerAngKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
